...
import {
    ...
    ISuperToken,
    IFluidspeedToken
} from "../interfaces/superfluid/IFluidspeed.sol";
...
contract TOGA is ITOGAv2, IERC777Recipient {
    ...
    IFluidspeed internal immutable _host;
    ...
    constructor(IFluidspeed host_, uint256 minBondDuration_, TokenCustodian custodian_) {
        _host = IFluidspeed(host_);
